    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-alert v-if="noticeList[0]" :closable="noticeList[0].closable">
          ...
          >
            <a target="_blank" href="https://github.com/chuzhixin/hym111">
              <img
                style="margin-right: 10px"
                src="https://img.shields.io/github/stars/chuzhixin/hym111?style=flat-square&label=Stars&logo=github"
              />
            </a>
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="11" :xl="11">
        ...
        <el-card shadow="never">
          ...
          <div style="text-align: center">
            ...
            <h1 style="font-size: 30px">hym111</h1>
          </div>
      ...
      return {
        ...
        iconList: [
          ...
          },
          {
            icon: 'laptop-code',
            title: '源码',
            link: 'https://github.com/chuzhixin/hym111',
            color: '#b37feb',
          },
          {
            icon: 'book',
